...
import { Calendar, MessageCircle, Users, Shield, Clock, Award } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Book appointments with licensed therapists at your convenience',
      color: 'text-blue-500'
    },
    {
      icon: MessageCircle,
      title: 'AI Wellness Assistant',
      description: '24/7 support with our intelligent chatbot for immediate guidance',
      color: 'text-emerald-500'
    },
    {
      icon: Shield,
      title: 'Secure & Private',
      description: 'Your mental health journey is protected with enterprise-grade security',
    ...
    <div className="space-y-12">
      ...
      <section className="text-center py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-8 leading-relaxed">
            Connect with licensed therapists, get instant AI support, and take control of your mental health 
            with our comprehensive wellness platform.
          </p>
      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="wellness-card p-8 hover:shadow-xl transition-all duration-300">
      ...
      <section className="wellness-card p-12 text-center bg-gradient-to-r from-blue-500/10 to-emerald-500/10">
        ...
        <p className="text-gray-600 mb-8 text-lg">
          Join thousands of people who have improved their mental health with MindWell
        </p>
        <button 
          onClick={() => onViewChange('appointments')}
          className="wellness-button text-lg px-8 py-4"
